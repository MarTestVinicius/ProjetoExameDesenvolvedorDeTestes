...
|---------------------------|----------------------------------------------------------------------------|
| testes apenas de API      |``` npx playwright test tests/API/pessoas_API.spec.js ```               |
| testes apenas de UI       |``` npx playwright test tests/UI/pessoas_UI.spec.js ```                 |
| testes apenas de Unit     |``` npx playwright test tests/Unit_Tests/pessoas_Unit_Tests.spec.js ``` |
...
## Bug 1: Mensagem informativa "Data de nascimento é obrigatória." não é apresentada corretamente
...
## Bug 2: Exibição da mensagem informativa "Data de nascimento não pode ser no futuro." não é apresentada corretamente
...
## Adição de body específico na API para atualização e remoção
...
## Adição da funcionalidade de pesquisa na aplicação
...
## Definição mais concreta do tipo de campo Nome
